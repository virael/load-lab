...
public class ConfigController {
    ...
    public ResponseEntity<?> updateConfig(@RequestBody ConfigRequest request) {
        ...
        long effectiveMin = request.minLatencyMs() != null ? request.minLatencyMs() : state.minLatencyMs();
        long effectiveMax = request.maxLatencyMs() != null ? request.maxLatencyMs() : state.maxLatencyMs();
