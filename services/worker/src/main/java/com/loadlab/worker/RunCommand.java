...
// Deliberate duplicate of the controller's RunCommand: the two services share a
// wire contract, not a codebase. Type headers are disabled on both sides so the
